...
<footer class="border-t py-8">
	<div class="mx-auto max-w-7xl px-4">
		<div class="grid grid-cols-1 gap-8 md:grid-cols-4">
			<div>
				<h3 class="mb-3 text-sm font-semibold">PNGS-IE</h3>
				<p class="text-muted-foreground text-xs">
					Plateforme Nationale de Gestion des Stages,<br />de l'Insertion et de l'Employabilité
				</p>
			</div>
			<div>
		...
		<div class="text-muted-foreground mt-8 border-t pt-4 text-center text-xs">
			&copy; 2024 PNGS-IE. Tous droits réservés.
		</div>
	</div>
</footer>
