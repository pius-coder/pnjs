...
- **Language**: TypeScript
- **Package Manager**: bun
- **UI System**: shadcn-svelte (Rhea preset, Inter font, Lucide icons)
- **CSS**: Tailwind CSS v4
...
- Material surface components go in `src/lib/components/material/`
- Pattern components go in `src/lib/components/patterns/`
